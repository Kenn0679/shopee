      ...
      <div className='container'>
        <div className='flex justify-end text-[0.875rem]'>
          ...
          >
            ...
            <span className='mx-1.5'>Tiếng Việt</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
          ...
          {isAuthenticated ? (
            <Popover
              ...
              renderPopover={
                <div className='bg-background relative shadow-md rounded-sm border border-gray-200'>
                  <Link to={endpoints.user.me} className='block bg-background py-2 px-3  hover:text-primary'>
                    Tài khoản của tôi
                  </Link>
                  <Link to={endpoints.purchase.addToCart} className='block bg-background py-2 px-3  hover:text-primary'>
                    Giỏ hàng
                  </Link>
                  <button
            ...
            <div className='flex items-center'>
              <Link to={endpoints.auth.register} className='mx-3 capitalize hover:text-primary-foreground opacity-70'>
                Đăng kí
              </Link>
              <div className='border-r border-r-primary-foreground/40 h-4' />
              <Link to={endpoints.auth.login} className='mx-3 capitalize hover:text-primary-foreground opacity-70'>
                Đăng nhập
              </Link>
            </div>
          )}
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to={endpoints.home} className='col-span-2 justify-self-start  outline-none border-none'>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex'>
              ...
              />
              <button className='rounded-sm py-2 px-6 shrink-0 bg-primary hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          >
            <Link to={endpoints.purchase.addToCart} className='flex h-full w-full items-center justify-center'>
              <ReactSVG
